    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-primary relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6">
        <div className="text-center space-y-3">
          <h1 className="text-5xl md:text-7xl font-extrabold text-primary-foreground tracking-tight">
            MAKIR
          </h1>
          <p className="text-sm md:text-base text-primary-foreground/50 max-w-md tracking-wide">
            CRM Eclesiástico — Gerencie visitantes, discipulado e grupos de crescimento de forma simples e eficiente.
          </p>
        </div>
